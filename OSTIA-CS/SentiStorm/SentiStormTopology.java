...
public class SentiStormTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Set Spout
    builder.setSpout("DatasetSpout", new DatasetSpout());

    // Set Spout --> TokenizerBolt
    builder.setBolt("TokenizerBolt", new TokenizerBolt())
        .shuffleGrouping("DatasetSpout");

    // TokenizerBolt --> PreprocessorBolt
    builder.setBolt("PreprocessorBolt", new PreprocessorBolt())
        .shuffleGrouping("TokenizerBolt");

    // PreprocessorBolt --> POSTaggerBolt
    builder.setBolt("POSTaggerBolt", new POSTaggerBolt())
        .shuffleGrouping("PreprocessorBolt");

    // POSTaggerBolt --> FeatureGenerationBolt
    builder.setBolt("FeatureGenerationBolt", new FeatureGenerationBolt())
        .shuffleGrouping("POSTaggerBolt");

    // FeatureGenerationBolt --> SVMBolt
    builder.setBolt("SVMBolt", new SVMBolt())
        .shuffleGrouping("FeatureGenerationBolt");
