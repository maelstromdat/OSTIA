...
\begin{figure}
\centering 
\subfigure[Multi-anchoring.]{\includegraphics[width=3.5cm]{images/multi-anchoring}}\caption{The multi-anchoring anti-pattern.}\label{fig:multi-anchoring1}
%\hspace{1cm}
\subfigure[Cycle-in.]{\includegraphics[width=2.25cm]{images/cycle}}\caption{The cycle-in anti-pattern.}\label{fig:cycle1}
\end{figure}
