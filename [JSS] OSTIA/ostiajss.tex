...
\title{Supporting Continuous Architecting of Data-Intensive Architectures}
...
From a software architecture perspective, DIAs are not properly \emph{software architectures}, i.e., a set of interconnected and inter-communicating components across a series of connectors and other architecture elements \cite{kazmanbook}. Rather, DIAs are concerned with \emph{topologies} of operations to be applied on the data - however, this topology bears the same weight on their performance and application properties. Therefore, we advocate an analogy between the classical notion of software architecture and the DIA notion of topology and for this reason, from now on, we use the terms topology and architecture interchangeably.
