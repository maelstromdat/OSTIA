...
\begin{figure}
\centering 
\subfigure[Multi-anchoring.]{\includegraphics[width=3cm]{images/multi-anchoring}}\label{fig:multi-anchoring}
\hspace{1cm}
\subfigure[Cycle-in.]{\includegraphics[width=2.5cm]{images/cycle}}\label{fig:cycle}
\end{figure}
...
assumption for the heuristic used in OSTIA to perform well.
