...
\begin{figure}
\centering 
\subfigure[Multi-anchoring.]{\includegraphics[width=2.5cm]{images/multi-anchoring}}\label{fig:multi-anchoring}
\hspace{1cm}
\subfigure[Cycle-in.]{\includegraphics[width=2.0cm]{images/cycle}}\label{fig:cycle}
\end{figure}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=4.5cm]{images/funnel}
...
\subsubsection{Linearising a topology}
