...
the quality of such architectures often requires iterative experiments on expensive multi-node clusters to continuously refactor the underlying architecture according to operational data. As an aid to designers and developers evolving their big data architectures, we
